...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/szxiaobei/TRUNetworking.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'TRUNetworking/Classes/**/*'
  s.resources = "TRUNetworking/Assets/*.png"
  s.resource_bundles = {
     'TRUNetworking' => ['TRUNetworking/**/*.{xib,png,xcassets}','TRUNetworking/Assets/*.png']
   }
